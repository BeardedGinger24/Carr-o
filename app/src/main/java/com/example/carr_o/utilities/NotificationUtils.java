...
import com.example.carr_o.sync.UpdateIntentService;
import com.example.carr_o.sync.UpdateTask;
...
public class NotificationUtils {
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        NotificationCompat.Action ignoreReminderAction = new NotificationCompat.Action(R.drawable.ic_warning_black_24dp,
                "Beat it!",
    ...
    private static Bitmap largeIcon(Context context){
        ...
        Bitmap largeIcon = BitmapFactory.decodeResource(res, R.drawable.ic_warning_black_24dp);
        return largeIcon;
    }
}

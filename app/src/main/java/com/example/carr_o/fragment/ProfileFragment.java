...
public class ProfileFragment extends Fragment implements View.OnClickListener {
    ...
    ImageButton mEditMiles;
    boolean vinBool = true;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mEditMiles = (ImageButton) view.findViewById(R.id.ib_edit_miles);
        ...
        mEditMiles.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(vinBool == false){
    ...
    void submitVINMiles(View view){
        if(vinBool == true) {
            ...
            int miles = Integer.parseInt(mMiles.getText().toString());
            vinDecodeViewModel.updateMiles(miles);
        }
